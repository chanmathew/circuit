...
export const MessageBranchPrevious = ({
  ...
  return (
    <Button
      ...
      {...props}
    >
      {children ?? <HugeiconsIcon icon={ArrowLeft01Icon} strokeWidth={2} className="size-3.5" />}
    </Button>
  );
};
...
export const MessageBranchNext = ({
  ...
  return (
    <Button
      ...
      {...props}
    >
      {children ?? <HugeiconsIcon icon={ArrowRight01Icon} strokeWidth={2} className="size-3.5" />}
    </Button>
  );
};
