...
export const PromptInputTextarea = ({
  ...
  return (
    <InputGroupTextarea
      className={cn('field-sizing-content max-h-48 min-h-16 px-3 py-2.5', className)}
      name="message"
...
export const PromptInputTools = ({ className, ...props }: PromptInputToolsProps) => (
  <div
    className={cn('flex min-w-0 flex-1 flex-nowrap items-center gap-1 overflow-visible', className)}
    {...props}
  />
)
...
export const PromptInputActionMenuContent = ({
  ...
  <DropdownMenuContent align="start" className={cn('w-auto min-w-52', className)} {...props} />
)
...
export const PromptInputSubmit = ({
  ...
  let Icon = <HugeiconsIcon icon={CornerDownLeftIcon} strokeWidth={2} className="size-4" />
